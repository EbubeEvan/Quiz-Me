  ...
  return (
    ...
    >
      <div className="flex justify-center flex-shrink-0 mt-20">
        <div className="pt-10">
          <div className="bg-red-500 h-56 w-56 mb-16 rounded-full relative left-[2rem] md:left-0">
            <p className="relative top-[6rem] left-[6rem] text-slate-50 text-5xl">{score}</p>
          </div>
          <Link to='/'>
