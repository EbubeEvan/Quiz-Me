...
const Score = () => {
  ...
  return (
    ...
    >
      <h1 className="text-center text-rose-900 text-5xl mt-7 md:mt-10 md:ml-[-3.5rem]">YOUR SCORE</h1>
      <div className="flex justify-center flex-shrink-0 mt-20">
        <div className="pt-10">
          <div className="bg-red-500 h-56 w-56 mb-16 rounded-full mt-[-2rem] ml-[2rem] md:mt-[-4rem] md:ml-0">
            <p className="relative top-[5.5rem] left-[6.2rem] text-slate-50 text-5xl">{score}</p>
          </div>
          <Link to='/'>
            <button className="bg-green-500 h-16 w-72 flex justify-center pt-[1rem] md:relative md:right-[2rem] rounded-md">
              New Quiz
            </button>
          </Link>
          {/* <button className="bg-orange-700 -500 h-16 w-72 flex justify-center pt-[1rem] md:relative md:right-[2rem] rounded-md mt-8">
          Corrections
          </button> */}
        </div>
      </div>
